...
public class Lvl5BossLaser extends Sprite{
		Sprite sprite = null; 
		Lvl5Boss callingBossHere = null;
		int count = 0;
		float fromX = 0;
		float fromY = 0;
		float rotAngle = 0;
	...
	public Lvl5BossLaser(ITextureRegion pTextureRegion, float x, float y, float rAngle, Lvl5Boss callingBoss) {
		...
		//mod = new MoveModifier(.5f, fromX, fromY, 1000, 1000);
					...
					if (((sprite.getRotation()<= -180.0) && (sprite.getRotation() > -270.0))){
						...
						final float pointsListX[] = {
								fromX, fromX+(float)(Math.random()*(ResourceManager.getInstance().cameraWidth*0.25f)),fromX+(float)(Math.random()*(ResourceManager.getInstance().cameraWidth*0.25f)),x+(float)(Math.random()*(ResourceManager.getInstance().cameraWidth*0.25f))
						};
						final float pointsListY[] = {
								fromY, fromY-(float)(Math.random()*(ResourceManager.getInstance().cameraWidth*0.25f)),fromY-(float)(Math.random()*(ResourceManager.getInstance().cameraWidth*0.25f)),y-(float)(Math.random()*(ResourceManager.getInstance().cameraWidth*0.25f))
						};
