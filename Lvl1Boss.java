...
public class Lvl1Boss extends Boss{
	...
	public Lvl1Boss(ITextureRegion pTextureRegion) {
	...
	private void setUpBoss() {
		...
		//GameLevel.getInstance().attachChild(sprite);
		bulletPool = new Lvl1BossLaserPool(8);
		//PLAYER LASER SETUP
		//Create new laser
				...
				if (GameLevel.getInstance().BossReady) {
					...
					if (recycleBullet == true){
						...
						if (bulletPool.getAvailableItemCount()>0){
							bullet = bulletPool.obtainPoolItem(sprite.getX(), sprite.getY(),-45, sprite);
							bullet2 = bulletPool.obtainPoolItem(sprite.getX(), sprite.getY(),-90, sprite);
							bullet3 = bulletPool.obtainPoolItem(sprite.getX(), sprite.getY(),-135, sprite);
							bullet4 = bulletPool.obtainPoolItem(sprite.getX(), sprite.getY(),-180, sprite);
							bullet5 = bulletPool.obtainPoolItem(sprite.getX(), sprite.getY(),-225, sprite);
							bullet6 = bulletPool.obtainPoolItem(sprite.getX(), sprite.getY(),-270, sprite);
							bullet7 = bulletPool.obtainPoolItem(sprite.getX(), sprite.getY(),-315, sprite);
							bullet8 = bulletPool.obtainPoolItem(sprite.getX(), sprite.getY(),-360, sprite);
						...
						bulletPool.recyclePoolItem((Lvl1BossLaser)bullet);
						bulletPool.recyclePoolItem((Lvl1BossLaser)bullet2);
						bulletPool.recyclePoolItem((Lvl1BossLaser)bullet3);
						bulletPool.recyclePoolItem((Lvl1BossLaser)bullet4);
						bulletPool.recyclePoolItem((Lvl1BossLaser)bullet5);
						bulletPool.recyclePoolItem((Lvl1BossLaser)bullet6);
						bulletPool.recyclePoolItem((Lvl1BossLaser)bullet7);
						bulletPool.recyclePoolItem((Lvl1BossLaser)bullet8);
